...
Use this folder as the operational entrypoint. Canonical files remain at `docs/` root for compatibility with automation and existing rules.
...
- [`../slos-and-chaos.md`](../slos-and-chaos.md) - Reliability objectives and chaos notes
- [`../verification-risk-register.md`](../verification-risk-register.md) - Risks and verification tracking

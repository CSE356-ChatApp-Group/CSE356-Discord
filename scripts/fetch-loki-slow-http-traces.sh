...
#
# Usage:
#   LOKI_URL=http://127.0.0.1:3100 WINDOW_MIN=15 ./scripts/fetch-loki-slow-http-traces.sh > traces.ndjson
#   node scripts/aggregate-slow-http-traces.cjs traces.ndjson
#
set -euo pipefail

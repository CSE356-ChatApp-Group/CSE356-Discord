...
#   REDIS_URL='redis://:pass@host:6379/0' ./scripts/redis/redis-emergency-trim-caches.sh
#   REDIS_URL='...' MAX_KEYS=100000 BATCH=500 ./scripts/redis/redis-emergency-trim-caches.sh 'stale:*'
#   DRY_RUN=1 REDIS_URL='...' ./scripts/redis/redis-emergency-trim-caches.sh
#
# Optional patterns (more aggressive — review before use):
#   ./scripts/redis/redis-emergency-trim-caches.sh 'channel:*:user_fanout_targets'
#   ./scripts/redis/redis-emergency-trim-caches.sh 'community:*:members'
#
set -euo pipefail

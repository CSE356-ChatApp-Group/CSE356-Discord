...
# Run periodically from your machine:  watch -n 120 ./scripts/ops/watch-traffic-concerns.sh
# Or loop:  INTERVAL_SEC=180 ./scripts/ops/watch-traffic-concerns.sh --loop
#

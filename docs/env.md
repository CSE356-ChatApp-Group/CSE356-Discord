...
| `MEILI_FRESHNESS_WINDOW_MS`, `MEILI_FRESHNESS_CANDIDATE_LIMIT` | Bounds the primary-DB freshness supplement used to rescue recently edited/deleted messages when Meili is stale. Defaults: **600000 ms** lookback and **40** candidates; clamps to **60000–3600000 ms** and **10–200** candidates in code. Prod pins **100** to reduce zero-candidate fallbacks for recently written messages. |

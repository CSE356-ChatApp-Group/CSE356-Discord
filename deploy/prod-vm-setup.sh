...
server {
  ...
  deny 47.20.119.33;
  # Heavy external traffic flood (Apr 2026); blocked on prod app hosts.
  deny 130.245.192.3;
  ...
  # Stops nginx 301 /api/v1/communities → …/communities/ (POST becomes GET without body in browsers).

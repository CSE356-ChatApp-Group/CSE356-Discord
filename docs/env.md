...
2. **`CHANNEL_MESSAGE_USER_FANOUT_MODE=recent_connect`** (avoid all-member user-topic duplicates)
...
5. Optional scale guards: **`CHANNEL_MESSAGE_RECENT_CONNECT_FALLBACK_PROBE_MAX=512`** and **`CHANNEL_MESSAGE_RECENT_CONNECT_INCLUDE_CONNECTED_FALLBACK=false`**

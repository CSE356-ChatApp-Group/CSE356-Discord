...
#   PROD_DB_SSH='ubuntu@130.245.136.21' ./scripts/pg-stat-statements-snapshot.sh   # same as prod-pg-stat-activity.sh
#
# Optional incident window (total_exec_time delta between two samples):
#   DELTA_SECONDS=120 PROD_DB_SSH=ubuntu@130.245.136.21 ./scripts/pg-stat-statements-snapshot.sh
#
# Tunables:
#   LIMIT            default 15

...
| `OPENSEARCH_URL`, `OPENSEARCH_USERNAME`, `OPENSEARCH_PASSWORD`, `OPENSEARCH_INDEX_MESSAGES` | OpenSearch endpoint/auth/index for candidate retrieval POC (`opensearchClient.ts`). |

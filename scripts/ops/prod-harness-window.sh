...
#
# Usage:
#   ./scripts/ops/prod-harness-window.sh '2026-04-12 05:10:00' '2026-04-12 05:22:00'
#   PADDING_MIN=2 ./scripts/ops/prod-harness-window.sh '2026-04-12 05:53:00' '2026-04-12 06:03:00'
#
...
if sum(status_lo.values()) == 0 and sum(status_strict.values()) == 0:
    print("--- (no access.log lines in these windows — current tail may not reach that UTC time; try ACCESS_TAIL_LINES=8000000 or ./scripts/ops/prod-log-correlate.sh for hour buckets) ---")
PY

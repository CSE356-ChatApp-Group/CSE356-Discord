 ...
 *
 * Direct one worker:
 *   BASE_URL=http://127.0.0.1:4000/api/v1 node scripts/prod-vm-ladder-loadtest.mjs
 *
 * Full fleet via nginx (VM only; INSECURE_TLS for cert/host mismatch on 127.0.0.1):
 *   INSECURE_TLS=1 BASE_URL=https://127.0.0.1/api/v1 node scripts/prod-vm-ladder-loadtest.mjs
 *

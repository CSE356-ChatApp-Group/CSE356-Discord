...
# Usage:
#   ./scripts/sync-sshd-ops-tuning.sh
#   STAGING_USER=ssperrottet STAGING_HOST=136.114.103.71 PROD_USER=ubuntu PROD_HOST=130.245.136.44 ./scripts/sync-sshd-ops-tuning.sh
set -euo pipefail
set -o pipefail
ROOT="$(cd "$(dirname "$0")/.." && pwd)"
CONF="${ROOT}/deploy/sshd-99-chatapp-ops-tuning.conf"
